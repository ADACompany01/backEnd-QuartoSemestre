...
module.exports = {
    async up(queryInterface) {
        const clientes = await queryInterface.sequelize.query('SELECT id FROM clientes LIMIT 2;', { type: queryInterface.sequelize.QueryTypes.SELECT });
        const servicos = await queryInterface.sequelize.query('SELECT id FROM servicos LIMIT 2;', { type: queryInterface.sequelize.QueryTypes.SELECT });
