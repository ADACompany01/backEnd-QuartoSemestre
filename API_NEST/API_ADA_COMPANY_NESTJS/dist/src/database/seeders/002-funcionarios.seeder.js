...
module.exports = {
    async up(queryInterface) {
        const usuarios = await queryInterface.sequelize.query('SELECT id_usuario FROM usuarios ORDER BY created_at ASC LIMIT 3 OFFSET 2;', { type: FuncionariosQueryTypes.SELECT });
